...
id = 1
start = time.time()
zkproof_real = zkp_generate(real_info, id)
zkproof_fake = zkp_generate(fake_info, id + 1)
print(zkproof_real.display())
print(zkproof_fake.display())
print(zkp_verify(zkproof_real, public_info, id))
print(zkp_verify(zkproof_fake, public_info, id))
